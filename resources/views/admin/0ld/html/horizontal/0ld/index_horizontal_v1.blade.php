...
<body>
                    ...
                    <div class="navbar-brand">
                        <a href="index.html" class="logo">
                            ...
                            <b class="logo-icon">
                                ...
                                <!-- Dark Logo icon -->
                                <img src="/nAdminPro/assets/images/logo-icon.png" alt="homepage" class="dark-logo" />
                                <!-- Light Logo icon -->
                                <img src="/nAdminPro/assets/images/logo-light-icon.png" alt="homepage" class="light-logo" />
                            </b>
                            <!--End Logo icon -->
                            <!-- Logo text -->
                            <span class="logo-text">
                                <!-- dark Logo text -->
                                <img src="/nAdminPro/assets/images/logo-text.png" alt="homepage" class="dark-logo" />
                                <!-- Light Logo text -->
                                <img src="/nAdminPro/assets/images/logo-light-text.png" class="light-logo" alt="homepage" />
                            </span>
                        </a>
                    </div>
                    <!-- ============================================================== -->
                    ...
                    <ul class="navbar-nav float-right">
                                    ...
                                    <li>
                                        <div class="message-center message-body">
                                            ...
                                            <a href="javascript:void(0)" class="message-item">
                                                <span class="user-img">
                                                    <img src="/nAdminPro/assets/images/users/1.jpg" alt="user" class="rounded-circle">
                                            ...
                                            <a href="javascript:void(0)" class="message-item">
                                                <span class="user-img">
                                                    <img src="/nAdminPro/assets/images/users/2.jpg" alt="user" class="rounded-circle">
                                            ...
                                            <a href="javascript:void(0)" class="message-item">
                                                <span class="user-img">
                                                    <img src="/nAdminPro/assets/images/users/3.jpg" alt="user" class="rounded-circle">
                                            ...
                                            <a href="javascript:void(0)" class="message-item">
                                                <span class="user-img">
                                                    <img src="/nAdminPro/assets/images/users/4.jpg" alt="user" class="rounded-circle">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle waves-effect waves-dark pro-pic" href="" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <img src="/nAdminPro/assets/images/users/2.jpg" alt="user" class="rounded-circle" width="40">
                            ...
                            <div class="dropdown-menu dropdown-menu-right user-dd animated flipInY">
                                ...
                                <div class="d-flex no-block align-items-center p-15 bg-primary text-white m-b-10">
                                    <div class="">
                                        <img src="/nAdminPro/assets/images/users/2.jpg" alt="user" class="rounded-circle" width="60">
                                    </div>
                                    <div class="m-l-10">
                    ...
                    <ul id="sidebarnav">
                        ...
                        <li class="sidebar-item mega-dropdown"> <a class="sidebar-link has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i class="mdi mdi-widgets"></i><span class="hide-menu">Ui </span></a>
                            <ul aria-expanded="false" class="collapse first-level">
                                ...
                                <li class="sidebar-item"><a href="ui-scrollspy.html" class="sidebar-link"><i class="mdi mdi-crop-free"></i><span class="hide-menu"> Scrollspy</span></a></li>
                                <li class="sidebar-item"><a href="ui-spinner.html" class="sidebar-link"><i class="mdi mdi-application"></i><span class="hide-menu"> Spinner</span></a></li>
                                <li class="sidebar-item"><a href="ui-toasts.html" class="sidebar-link"><i class="mdi mdi-apple-safari"></i><span class="hide-menu"> Toasts</span></a></li>
                        ...
                        <div class="card">
                            ...
                            <div class="comment-widgets scrollable" style="height:430px;">
                                ...
                                <div class="d-flex flex-row comment-row m-t-0">
                                    <div class="p-2">
                                        <img src="/nAdminPro/assets/images/users/1.jpg" alt="user" width="50" class="rounded-circle">
                                    </div>
                                ...
                                <div class="d-flex flex-row comment-row">
                                    <div class="p-2">
                                        <img src="/nAdminPro/assets/images/users/4.jpg" alt="user" width="50" class="rounded-circle">
                                    </div>
                                ...
                                <div class="d-flex flex-row comment-row">
                                    <div class="p-2">
                                        <img src="/nAdminPro/assets/images/users/5.jpg" alt="user" width="50" class="rounded-circle">
                                    </div>
                                    <div class="comment-text w-100">
                                ...
                                <div class="d-flex flex-row comment-row m-t-0">
                                    <div class="p-2">
                                        <img src="/nAdminPro/assets/images/users/2.jpg" alt="user" width="50" class="rounded-circle">
                                    </div>
                                    <div class="comment-text w-100">
    ...
    <script src="/nAdminPro/dist/js/app.init.horizontal.js"></script>
    <script src="/nAdminPro/dist/js/app-style-switcher.horizontal.js"></script>
    ...
    <!--Custom JavaScript -->
    <script src="/nAdminPro/dist/js/custom.js"></script>
    <!--This page JavaScript -->
    <!--chartis chart-->
    <script src="/nAdminPro/assets/libs/chartist/dist/chartist.min.js"></script>
    <script src="/nAdminPro/assets/libs/chartist-plugin-tooltips/dist/chartist-plugin-tooltip.min.js"></script>
    <!--c3 charts -->
    <script src="/nAdminPro/assets/extra-libs/c3/d3.min.js"></script>
    <script src="/nAdminPro/assets/extra-libs/c3/c3.min.js"></script>
    <script src="/nAdminPro/assets/extra-libs/jvector/jquery-jvectormap-2.0.2.min.js"></script>
    <script src="/nAdminPro/assets/extra-libs/jvector/jquery-jvectormap-world-mill-en.js"></script>
