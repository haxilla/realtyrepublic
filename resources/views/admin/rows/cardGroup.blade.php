                ...
                <div class="col-md-12">
                    <div class="d-flex no-block align-items-center">
                        <div>
                            ...
                            <p class="font-16 m-b-5">Support<Br>Requests</p>
                        </div>
                        <div class="ml-auto">
                ...
                <div class="col-md-12">
                    <div class="d-flex no-block align-items-center">
                        <div>
                            ...
                            <p class="font-16 m-b-5">Member<br>Messages</p>
                        </div>
                        <div class="ml-auto">
                ...
                <div class="col-md-12">
                    <div class="d-flex no-block align-items-center">
                        <div>
                            ...
                            <p class="font-16 m-b-5">Trial<Br>Requests</p>
                        </div>
                        <div class="ml-auto">
                ...
                <div class="col-md-12">
                    <div class="d-flex no-block align-items-center">
                        <div>
                            ...
                            <p class="font-16 m-b-5">Campaign<BR>Reviews</p>
                        </div>
                        <div class="ml-auto">
