   ...
   padding-top:10px;padding-bottom:10px;">
      <div class="col-sm-6">
         <div style="text-align:center;">
            ...
            class="adminPhotoDisplay" style="max-height:110px;">
         </div>
      </div>
      <div class="col-sm-6">
...
display:none;color:#223e94;margin:15px;padding:15px;border-radius:.25rem;">
   ...
   <div class="adminPhotoDeleteDiv" style="display:none;">
      <div class="row">
         <div class="col-lg-3">
            <img src="/adminPhotos/{{$adminInfo['adminPhoto']}}"
            style="max-height:85px;max-width:125px;display:block;" 
            class="adminProfilePhoto">
         </div>
         <div class="col-lg-6" style="margin-top:auto;margin-bottom:auto;
         color:#900">
            Are you <b>SURE</b> you want to <b>DELETE</b> this photo?
         </div>
         <div class="col-lg-3" style="margin-top:auto;margin-bottom:auto;">
            <div style="background:#0082cb;color:#fff;padding:5px;margin:5px;
            text-align:center;border-radius:2em;border:2px solid #fff;
