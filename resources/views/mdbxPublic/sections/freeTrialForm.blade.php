...
<div class="freeTrialSection backgroundSecondary textCenter">
	<div class="svg-row" style="margin:0;">
		...
		<div class="col-12">
			<div class="freeTrial">
				<div class="row">
					<div class="col-12">
							<div class="colWrapper textPrimary">
								<div>
									<div class="circle ticon orangeGradient padding3">
										<div class="circle backgroundPrimary">
											<span class="ti-wand gradientText">
											</span>
										</div>
									</div>
									<div class="preHead">
								...
								<div class="formWrapper">
									<form action="/trialAccount"
									method="POST" id="freeTrialAddressForm"
									class="clearForm">
										{{csrf_field()}}
