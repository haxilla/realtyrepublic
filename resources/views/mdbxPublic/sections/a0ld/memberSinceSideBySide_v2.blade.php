<div class="memberSince backgroundPrimary">
	<div class="row noMargin">
		...
		<div class="col-lg-8">
			<div class="row noMargin agentWallHero">
				<div class="col-12">
					...
					<h3 style="border-bottom:1px solid #fff;
					padding-bottom:25px;">
						<span class="ti-cup" style="margin-right:15px;">
						</span>
			...
			<div class="row">
				...
				margin-bottom:25px;">
					<div class="orangeGradientRoundest">
						<button style="background:#900;padding:15px 20px;color:#fff;
						border-radius:2em;font-weight:bold;border:none;"
