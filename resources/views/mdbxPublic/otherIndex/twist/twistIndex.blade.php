...
<html lang="en">
    ...
    @include('mdbxPublic.otherHeaders.twist.pubHeader')

    <body>
        <!--Navbar-->
        @include('mdbxPublic.otherNavigation.twist.pubNavTop')
        <!--Landing -->
        <section style="background: linear-gradient(146deg, #223e94, #303030);
        ...
        -->
            <div class="container-fluid">
                @include('mdbxPublic.otherIncludes.twist.sections.landingPage')
            </div>
        </section>
        <!-- section 1 -->
        <section>
            <div style="padding:50px 30px;">
                @include('mdbxPublic.otherIncludes.twist.sections.3colFeatures')
            </div>
        </section>
        <!-- section 2-->
        <section>
            <div class="container-fluid">
                @include('mdbxPublic.otherIncludes.twist.sections.mostViewsListx')
            </div>
        </section>
