...
<head>
    @include('mdbxPublic.otherHeaders.fresh.pubHeader')
</head>
...
<body class="software-lp">
    ...
    <header>
        ...
        <!--Navbar-->
        @include('mdbxPublic.otherNavigation.fresh.pubNavTop')
    ...
    <main>
        <div class="container-fluid" style="margin-top:60px;">
            @include('mdbxPublic.otherIncludes.fresh.multiPhotoCarouselExample1')
        </div>
        <div class="container-fluid">
            @include('mdbxPublic.otherIncludes.fresh.mainAd')
        </div>
        <!--First container-->
        <div class="container">
    ...
    <script type="text/javascript" src="/otherJS/fresh/IEfix.js"></script>
