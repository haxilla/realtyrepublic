...
<head>
    @include('mdbxPublic.otherHeaders.mango.pubHeader')
</head>
...
<body>
    ...
    <header>
        ...
        <!--Navbar-->
        @include('mdbxPublic.otherNavigation.mango.pubNavTop')
    ...
    <main>
        <div class="background-darktweed2">
            <div style="padding-top:70px;">
                <div class="text-white font-Lora padding25 background-transBlack6">
                    <div class="container" style="text-align:center;">
                        <h1 style="font-size:28px;">
                            Premium Online Real Estate Flyers 
                        </h1>
                    </div>
                </div>
            </div>
            <div class="container" style="max-width:1000px;padding-top:50px;">
                @include('mdbxPublic.otherIncludes.mango.fullScreenCarousel')
            </div>
        </div>
        <div class="container-fluid">
            @include('mdbxPublic.otherIncludes.mango.mainAd')
        </div>
        <!--First container-->
        <div class="container">
