...
<html lang="en">
    ...
    @include('mdbxPublic.otherHeaders.sunset.pubHeader')

    <body>
        <!--Navbar-->
        @include('mdbxPublic.otherNavigation.sunset.pubNavTop')
        <!--Landing -->
        <section class="
            ...
            <div class="container-fluid" style="margin-bottom:75px;">
                @include('mdbxPublic.otherIncludes.sunset.sections.landingPage')
            </div>
            <div style="position:absolute;bottom:0;">
                <img src="/images/pointBottom.png" style="width:100%;">
            </div>
        </section>
        <!-- section 1 -->
        <section>
            <div style="padding:50px 30px;">
                ...
                @include('mdbxPublic.otherIncludes.sunset.sections.3colFeatures')
            </div>
        </section>
        <!-- section 2-->
        <section>
            <div class="container-fluid">
                @include('mdbxPublic.otherIncludes.sunset.sections.mostViewsListx')
            </div>
        </section>
