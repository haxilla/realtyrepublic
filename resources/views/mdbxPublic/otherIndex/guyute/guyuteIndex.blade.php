...
<head>
    @include('mdbxPublic.otherHeaders.guyute.pubHeader')
</head>
...
<body>
    ...
    <header>
        ...
        <!--Navbar-->
        @include('mdbxPublic.otherNavigation.guyute.pubNavTop')
    ...
    <!--Main content-->
    <main>
        <div class="background-darktweed2" style="padding-top:64px;">
            <div class="container">
                @include('mdbxPublic.otherIncludes.guyute.singlePhotoCarousel1')
            </div>
        </div>
        <div class="container-fluid">
            @include('mdbxPublic.otherIncludes.guyute.mainAd')
        </div>
        <!--First container-->
        <div class="container">
