...
<body>
    ...
    <header>
        ...
        <!--Navbar-->
        @include('mdbxPublic.otherNavigation.phoneApp.pubNavTop')
    ...
    <main>
        ...
        <div>
            @include('mdbxPublic.otherIncludes.phoneApp.c-landingPage')
        <div>
