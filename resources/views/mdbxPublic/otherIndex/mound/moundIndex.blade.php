...
<html lang="en">
    ...
    <body style="font-family:Roboto">
        <!--Navbar-->
        @include('mdbxPublic.otherNavigation.mound.pubNavTop')
        <!--Landing -->
        <section>
            @include('mdbxPublic.otherIncludes.mound.sections.landingPageThemes')
        </section>
        <section>
            @include('mdbxPublic.otherIncludes.mound.sections.mostViewsList4up')
        </section>
        <section>
            @include('mdbxPublic.otherIncludes.mound.sections.remHelped')
        </section>
        <section>
            @include('mdbxPublic.otherIncludes.mound.sections.remReasons')
        </section>
        <!-- section 1 -->
        ...
        <script type="text/javascript" src="/otherJS/mound/landing.js"></script>
        <script>
