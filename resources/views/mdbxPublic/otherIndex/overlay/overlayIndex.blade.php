...
<html lang="en">
    ...
    <body style="font-family:Roboto">
        <!--Navbar-->
        @include('mdbxPublic.otherNavigation.overlay.pubNavTop')
        <!--Landing -->
        <section>
            @include('mdbxPublic.otherIncludes.overlay.sections.landingPageThemes')
        </section>
        <section>
            @include('mdbxPublic.otherIncludes.overlay.sections.mostViewsList4up')
        </section>
        <section>
            @include('mdbxPublic.otherIncludes.overlay.sections.remHelped')
        </section>
        <section>
            @include('mdbxPublic.otherIncludes.overlay.sections.remReasons')
        </section>
        <!-- section 1 -->
        ...
        <script type="text/javascript" src="/customJS/overlay/landing.js"></script>
        <script>
