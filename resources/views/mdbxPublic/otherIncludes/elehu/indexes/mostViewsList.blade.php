<div style="background-image: linear-gradient(to right bottom, #6e6c4a, #6d6d4b, #6c6f4b, #6b704c, #6a724d, #69734e, #67754e, #66764f, #647850, #637952, #617b53, #5f7c55);">
    <section>
    <div>
      ...
      class="divider-new">
        THIS WEEK'S TOP VIEWED E-FLYERS!
      </h1>
    </div>
            ...
            <div style="position:relative;border:5px solid #fff;">
              <a href="/propInfo?id={{$mv->theMeta->sk1}}">
                <img src="/hqphotos/{{ $mv->theMeta->zipDir }}/{{$mv->theMeta
                  ...
                  class="colIndexPhoto img-responsive" style="object-fit:cover;">
              </a>
