...
<body class="software-lp">
    ...
    <main>
                ...
                <section>
                    ...
                    <div class="row my-4 pt-5 wow fadeIn" data-wow-delay="0.4s">
                        ...
                        <div class="col-lg-7 col-md-12 mb-r text-center">
                            <img src="/images/adminPanel.jpg" alt="" class="img-fluid z-depth-2 rounded">
                        </div>
                        <!-- /First column -->
        ...
        <!--Third container-->
        <div class="streak streak-md streak-photo" style="background-image:url('/images/architecture.jpg')">
