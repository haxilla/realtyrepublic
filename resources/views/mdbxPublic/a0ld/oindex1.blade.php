...
<head>
    ...
    <link href="/landingCSS/mdb.min.css" rel="stylesheet">
    <!-- custom -->
...
<body class="software-lp">
    ...
    <!--Main Navigation-->
    <header>
        @include('mdbxPublic.includes.navigation.pubNavTop')
    </header>

    <!--Main content-->
    <main>
        <!--First container-->
        @include('mdbxPublic.includes.sections.showcaseHomes')
        <!--Second container-->
        <div>
            <div class="container-fluid" style="max-width:1200px;">
                @include('mdbxPublic.includes.sections.mainAd')
            </div>
        </div>
        ...
        style="background-image:url('/images/architecture.jpg')">
            <div class="flex-center white-text mask rgba-green-strong">
                <div class="container py-3">
                    ...
                    <section class="section feature-box wow fadeIn" data-wow-delay="0.2s">
                        ...
                        <!--Section heading-->
                        <h1 class="py-5 my-5 white-text text-center wow fadeIn" data-wow-delay="0.2s"><strong class="font-bold">THIS WEEKS</strong> TOP VIEWED</h1>
                        ...
                        <div class="row features-small mb-5">
                            ...
                            <div class="col-md-12 col-lg-4 px-5 mb-2 center-on-small-only flex-center">
                                <img src="/images/straightPhone.png" alt="" class="z-depth-0 img-fluid">
                            </div>
                            <!--Grid column-->
                            ...
                            <div class="carousel-item active">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="testimonial">
                                        <!--Avatar-->
                                        <div class="avatar">
                                            <img src="/images/examples/avatars/img%20(26).jpg" class="rounded-circle img-fluid">
                                        </div>
                                        <!--Content-->
                                ...
                                <div class="col-md-4 clearfix d-none d-md-block">
                                    <div class="testimonial">
                                        <!--Avatar-->
                                        <div class="avatar">
                                            <img src="/images/examples/avatars/img%20(8).jpg" class="rounded-circle img-fluid">
                                        </div>
                                        <!--Content-->
                                ...
                                <div class="col-md-4 clearfix d-none d-md-block">
                                    <div class="testimonial">
                                        <!--Avatar-->
                                        <div class="avatar">
                                            <img src="/images/examples/avatars/img%20(31).jpg" class="rounded-circle img-fluid">
                                        </div>
                                        <!--Content-->
                            ...
                            <div class="carousel-item">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="testimonial">
                                        <!--Avatar-->
                                        <div class="avatar">
                                            <img src="/images/examples/avatars/img%20(4).jpg" class="rounded-circle img-fluid">
                                        </div>
                                        <!--Content-->
                                ...
                                <div class="col-md-4 clearfix d-none d-md-block">
                                    <div class="testimonial">
                                        <!--Avatar-->
                                        <div class="avatar">
                                            <img src="/images/examples/avatars/img%20(5).jpg" class="rounded-circle img-fluid">
                                        </div>
                                        <!--Content-->
                                ...
                                <div class="col-md-4 clearfix d-none d-md-block">
                                    <div class="testimonial">
                                        <!--Avatar-->
                                        <div class="avatar">
                                            <img src="/images/examples/avatars/img%20(28).jpg" class="rounded-circle img-fluid">
                                        </div>
                                        <!--Content-->
