$(function() {
   ...
   $('#clickSynchAll').click(function(e){
      //turn on modal
      e.preventDefault();
      $('#clickSynchModal').modal('toggle');
      //start request
      var theURL='/admin/synchStart';
      $('#synchMessage1ModalDiv').text('Resetting Agents');
      $('#synchMessage2ModalDiv').text("I'll let you know when done");
      ajaxGetRequest(theURL);
   });

   function ajaxGetRequest(theURL){

      //change modal to indicate its starting
      $('#synchStatusModalDiv').text('Standby... Synch In Progress');
