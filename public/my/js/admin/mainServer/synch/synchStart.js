$(function() {
   ...
   $('body').on('click','.startSynch', function(e){
      ...
      $('.synchDownload tr.'+currentSynch+'.synchProgress').css({
      ...
      //set progressURL
      var progressURL='/synch/synchProgress?synchType='+
      synchType+'&currentSynch='+currentSynch;
      ...
      dataType: "json",
         ...
         success: function(data) {
            ...
            if(tableComplete != null){
               ...
               //update width
               $('.'+tableComplete+'.synchProgress .progress-bar').css({
                  "width":"100%"
               });
               //update display
               $('.'+tableComplete+'.synchProgress .progressWaitText ').html("100% Complete!");
               $('.'+tableComplete+'.synchProgress .progressWait').show();
               $('.'+tableComplete+'.synchProgress .progress').hide();
            }
   ...
   function checkProgress(progressURL){
      ...
      $.ajax({
         ...
         success: function(data){
            ...
            //highlight active
            $('.synchTable tr'+'.'+currentSynch).css({"opacity":"1"});
            $('.'+currentSynch+'.synchProgress').css({
               "background":"rgba(255,255,255,.3)"
            });
