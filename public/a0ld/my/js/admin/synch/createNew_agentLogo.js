$(function(){
   ...
   $('#createNew_agentLogo').click(function(){
      theURL='/admin/synch/createNew_agentLogo';
      //open modal
      $('#synchAgentPhotoModal').modal();
      //ajax call
      ajax_createNew_agtLogo(theURL);
   });

   function ajax_createNew_agtLogo(theURL){
      //ajax call
      $.ajax({
         type: "get",
         dataType: "json",
         ...
         success: function (data) {
            ...
            //check logoCounts
            if(agentLogoFix && logoCheckCount>1){
