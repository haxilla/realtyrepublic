...
->get();
?>
<div class="officeResultsFullDiv">
   <?php
   echo"<div id='xOfficeIDval'>";
   echo $xOfficeID;
   echo"</div>";
   ...
   <div>
      <div style="float:left">
         <?php foreach($getOffice3 as $the){?>
         <div
         class="officeSelectRecord
      ...
      <div style="float:right">
         <div class="sticky">
            <button class="btn btn-danger btn-sm closeOfficeResult">
               EXIT
            </button>
         </div>
      </div>
