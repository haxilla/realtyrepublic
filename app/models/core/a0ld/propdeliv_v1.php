...
class propdeliv_v1 extends \App\Model
{
   protected $primaryKey   = 'cid';
   protected $dates = ['emRequest','emStart','emComplete',
   'created_at','updated_at'];

   public static function recentCompleteCount(){
      $oneDayBehind=\Carbon\Carbon::now()->subDays(1);
      $recentCompleteCount=static::whereNotNull('emComplete')
      ->where('emComplete','>',$oneDayBehind)
      ->orderBy('emComplete','desc')
      ->count();
      return $recentCompleteCount;
   }
   ...
   public static function thisDelivCount(){
      return static::count();
   }
