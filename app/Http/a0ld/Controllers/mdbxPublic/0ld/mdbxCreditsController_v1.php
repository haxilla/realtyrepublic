...
class mdbxCreditsController_v1 extends Controller
{
   ...
   public function mdbxNewPurchase(){
      ...
      if(!$amt||!$newPurchaseEmail||!$theState){
         dd('error-line24-mdbxCreditsController');}

      //set route based on state
      if($theState=='AZ'){
         $theRoute='public.azPrice';
      }elseif($theState=='NV'){
         $theRoute='public.nvPrice';
      }else{
         $theRoute='public.index';}

      //if not an expected number, error out
      if($amt!=='1' && $amt!=='3' && $amt!=='5'
      && $amt !=='10' && $amt !=='15' & $amt !== '99'){
         dd('error-line37-mdbxCreditsController');}
      ...
      if($dup){
         return \Redirect::route($theRoute,[
            'dup'=>1,
   ...
   public function mdbxPurchaseConfirm(){
      ...
      return view('public.newPurchaseConfirm',[
         'amt'          => $amt,
         'theEmail'     => $theEmail,
         'umid'         => $umid,
