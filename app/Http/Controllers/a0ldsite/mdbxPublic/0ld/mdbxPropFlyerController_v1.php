...
use App\models\core\pubContact;
...
class mdbxPropflyerController_v1 extends Controller
{
  ...
  public function rosemary(){
    //set variables for login errors
    $dup=request('dup');
    ...
    //return view
    return view('mdbxPublic.otherIndex.rosemary.rosemaryIndex',
      [
        'newAdds'     => $newAdds,
        'mostViews'   => $mostViews,
        'checkTrial'  => 'index',
  ...
  public function fresh(){
    ...
    include(app_path().'/queries/indexQuery.php');
    //return view
    return view('mdbxPublic.otherIndex.fresh.freshIndex',
      [
        'newAdds'     => $newAdds,
        'mostViews'   => $mostViews,
        'checkTrial'  => 'index',
  ...
  public function elehu(){
    ...
    include(app_path().'/queries/indexQuery.php');
    //return view
    return view('mdbxPublic.otherIndex.elehu.elehuIndex',
      [
        'newAdds'     => $newAdds,
        'mostViews'   => $mostViews,
        'checkTrial'  => 'index',
  ...
  public function guyute(){
    ...
    include(app_path().'/queries/indexQuery.php');
    //return view
    return view('mdbxPublic.otherIndex.guyute.guyuteIndex',
      [
        'newAdds'     => $newAdds,
        'mostViews'   => $mostViews,
        'checkTrial'  => 'index',
  ...
  public function mango(){
    ...
    include(app_path().'/queries/indexQuery.php');
    //return view
    return view('mdbxPublic.otherIndex.mango.mangoIndex',
      [
        'newAdds'     => $newAdds,
        'mostViews'   => $mostViews,
        'checkTrial'  => 'index',
  ...
  public function rift(){
    ...
    include(app_path().'/queries/indexQuery.php');
    //return view
    return view('mdbxPublic.otherIndex.rift.riftIndex',
      [
        'newAdds'     => $newAdds,
        'mostViews'   => $mostViews,
        'checkTrial'  => 'index',
  ...
  public function thePhone(){
    ...
    include(app_path().'/queries/indexQuery.php');
    //return view
    return view('mdbxPublic.otherIndex.thePhone.thePhoneIndex',
      [
        'newAdds'     => $newAdds,
        'mostViews'   => $mostViews,
        'checkTrial'  => 'index',
  ...
  public function phoneApp(){
    ...
    include(app_path().'/queries/indexQuery.php');
    //return view
    return view('mdbxPublic.otherIndex.phoneApp.phoneAppIndex',
      [
        'newAdds'     => $newAdds,
        'mostViews'   => $mostViews,
        'checkTrial'  => 'index',
  ...
  public function siren(){
    ...
    include(app_path().'/queries/indexQuery.php');
    //return view
    return view('mdbxPublic.otherIndex.siren.sirenIndex',
      [
        'newAdds'     => $newAdds,
        'mostViews'   => $mostViews,
        'checkTrial'  => 'index',
  ...
  public function twist(){
    ...
    include(app_path().'/queries/indexQuery.php');
    //return view
    return view('mdbxPublic.otherIndex.twist.twistIndex',
      [
        'newAdds'     => $newAdds,
        'mostViews'   => $mostViews,
        'checkTrial'  => 'index',
  ...
  public function wedge(){
    ...
    include(app_path().'/queries/indexQuery.php');
    //return view
    return view('mdbxPublic.otherIndex.wedge.wedgeIndex',
      [
        'newAdds'     => $newAdds,
        'mostViews'   => $mostViews,
        'checkTrial'  => 'index',
  ...
  public function blueSmoke(){
    ...
    include(app_path().'/queries/indexQuery.php');
    //return view
    return view('mdbxPublic.otherIndex.blueSmoke.blueSmokeIndex',
      [
        'newAdds'     => $newAdds,
        'mostViews'   => $mostViews,
        'checkTrial'  => 'index',
  ...
  public function theBlues(){
    ...
    include(app_path().'/queries/indexQuery.php');
    //return view
    return view('mdbxPublic.otherIndex.theBlues.theBluesIndex',
      [
        'newAdds'     => $newAdds,
        'mostViews'   => $mostViews,
        'checkTrial'  => 'index',
  ...
  public function sunset(){
    ...
    include(app_path().'/queries/indexQuery.php');
    //return view
    return view('mdbxPublic.otherIndex.sunset.sunsetIndex',
      [
        'newAdds'     => $newAdds,
        'mostViews'   => $mostViews,
        'checkTrial'  => 'index',
  ...
  public function mound(){
    ...
    include(app_path().'/queries/indexQuery.php');
    //return view
    return view('mdbxPublic.otherIndex.mound.moundIndex',
      [
        'newAdds'     => $newAdds,
        'mostViews'   => $mostViews,
        'checkTrial'  => 'index',
  ...
  public function overlay(){
    ...
    include(app_path().'/queries/indexQuery.php');
    //return view
    return view('mdbxPublic.otherIndex.overlay.overlayIndex',
      [
        'newAdds'     => $newAdds,
        'mostViews'   => $mostViews,
        'checkTrial'  => 'index',
  ...
  public function rooftop(){
    ...
    include(app_path().'/queries/indexQuery.php');
    //return view
    return view('mdbxPublic.otherIndex.rooftop.rooftopIndex',
      [
        'newAdds'     => $newAdds,
        'mostViews'   => $mostViews,
        'checkTrial'  => 'index',
  ...
  public function scent(){
    ...
    include(app_path().'/queries/indexQuery.php');
    //return view
    return view('mdbxPublic.otherIndex.scent.scentIndex',
      [
        'newAdds'     => $newAdds,
        'mostViews'   => $mostViews,
        'checkTrial'  => 'index',
