...
class mdbxCreditsController extends Controller
{
   ...
   public function mdbxNewPurchase(){
      ...
      return \Redirect::route('public.newPurchaseConfirm',['shortKey'=>$enc]);
   ...
   public function mdbxPurchaseConfirm(){
      ...
      //error if none
      if(!$shortKey){
         dd('error-line103-mdbxCreditsController');}
      //get theAgent
      $theAgent=newaccessrequest::where('key','=',$shortKey)
      ->first();
      //error if none
      if(!$theAgent){
         dd('error-line109-mdbxCreditsController');}
      //return view
