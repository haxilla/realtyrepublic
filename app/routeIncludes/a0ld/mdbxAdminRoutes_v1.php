...
//testing
Route::get('/adminSample',[
   'as'=>'admin.sample',
   'uses' => 'admin\adminIndexController@adminSample']);
...
//mdbxFlyerCheckController
   //show
   Route::get('/admin/flyerCheck',[
      'as'     => 'admin.flyerCheck',
      'uses'   => 'mdbxAdmin\mdbxFlyerCheckController@show']);
