<?php
//models
Use App\models\oldsite\oldetrack2018;
Use App\models\etrack\etrack2018;

//last date comparison
$local=etrack2018::select('etrackid','etrackdate')
->orderby('etrackdate','desc')
->whereNotNull('etrackdate')
->first();
$remote=oldetrack2018::select('etrackid','etrackdate')
->orderby('etrackdate','desc')
->whereNotNull('etrackdate')
->first();
$localDate=$local['etrackdate'];
//get new record
$update=oldetrack2018::where('etrackDate','>',$localDate)
->whereNotNull('etrackdate')
->get();
