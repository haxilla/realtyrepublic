...
Schema::dropIfExists('remaildeliveries2019_federated');
Schema::connection('remailsynch')
->dropIfExists('remaildeliveries2019_federated');
//create federated table
//first need to get by original field names
$results=DB::select( DB::raw("
  CREATE TABLE remailsynch.remaildeliveries2019_federated (
    ufid                INT,
  ...
  CONNECTION='mysql://oldsiteuser:ZUb40d4vid@www.realtyemails.com:3306/maindata/remaildeliveries2019';
"));
...
//drop old
Schema::dropIfExists('remaildeliveries2019Backup');
Schema::connection('remailsynch')
...
//re-create
$results=DB::select( DB::raw("
  create table maindata.remaildeliveries2019
  like remailsynch.remaildeliveries2019
"));

// ** BEGIN INSERT
// Insert
DB::select( DB::raw("
  INSERT INTO maindata.remaildeliveries2019
    (
    propflyer_id,
    emSubject,
    emArea,
  ...
  SELECT
    ...
    server,
    free
  FROM  remailsynch.remaildeliveries2019_federated
"));

//2nd backup
//delete if exists
Schema::dropIfExists('remaildeliveries2019Synch');
Schema::connection('remailsynch')
