...
$results=DB::select( DB::raw("
  CREATE TABLE remailsynch.remaildeliveriesmaster_federated (
    ufid                INT,
  ...
  CONNECTION='mysql://oldsiteuser:ZUb40d4vid@www.realtyemails.com:3306/maindata/remaildeliveriesmaster';
"));
